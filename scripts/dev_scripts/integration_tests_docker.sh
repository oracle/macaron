...
$RUN_MACARON_SCRIPT -t $GITHUB_TOKEN analyze -pe $CUE_POLICY $DATALOG_POLICY -rp https://github.com/urllib3/urllib3/urllib3 -b main -d 87a0ecee6e691fe5ff93cd000c0158deebef763b --skip-deps || log_fail
