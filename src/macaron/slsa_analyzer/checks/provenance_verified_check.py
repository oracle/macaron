...
class ProvenanceVerifiedFacts(CheckFacts):
    ...
    build_level: Mapped[str] = mapped_column(String, nullable=True, info={"justification": JustificationType.TEXT})
    ...
    def run_check(self, ctx: AnalyzeContext) -> CheckResultData:
            ...
            return CheckResultData(
                result_tables=[
                    ProvenanceVerifiedFacts(
                        build_level="SLSA Build Level: 0 -- The provenance does not exist.", confidence=Confidence.HIGH
                    )
                ],
        ...
        if not ctx.dynamic_data["provenance_verified"]:
            ...
            return CheckResultData(
                result_tables=[
                    ProvenanceVerifiedFacts(
                        build_level="SLSA Build Level: 1 -- The provenance exists but is not verified.",
        ...
        if not (build_type and build_type == "https://github.com/slsa-framework/slsa-github-generator/generic@v1"):
            ...
            return CheckResultData(
                result_tables=[
                    ProvenanceVerifiedFacts(
                        build_level="SLSA Build Level: 2 -- The provenance is verified.", confidence=Confidence.HIGH
                    )
                ],
        ...
        return CheckResultData(
            result_tables=[
                ProvenanceVerifiedFacts(
                    build_level="SLSA Build Level: 3 -- The provenance is generated by SLSA GitHub Generator"
                    " and is verified.",
                    confidence=Confidence.HIGH,
                )
            ],
