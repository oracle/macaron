...
.. glossary::
    ...
    Witness
        ...
        * Witness is a tool that wraps a build command and records various types of information in a provenance document in ``in-toto`` format as the build execution happens.
