...
"""This module test the slsa_analyzer.Gh module."""

import os
from pathlib import Path

from macaron.config.defaults import defaults
from macaron.slsa_analyzer.analyzer import Analyzer, git_url
...
class TestAnalyzer(MacaronTestCase):
    ...
    def test_get_repo_name_from_url(self) -> None:
        """
    ...
    def test_clone_remote_repo(self) -> None:
        """
        Test the clone remote repository method
        """
        assert not git_url.clone_remote_repo(self.PARENT_DIR, "")

    def test_is_remote_repo(self) -> None:
        """
    ...
    def test_clean_up_repo_path(self) -> None:
        ...
        assert (
            git_url.clean_up_repo_path("https://github.com/xmlunit/xmlunit.git") == "https://github.com/xmlunit/xmlunit"
        )
    ...
    def test_get_remote_vcs_url(self) -> None:
        ...
        assert (
            git_url.get_remote_vcs_url("scm:git+ssh://git@gitlab.com/org/name/foo/bar") == "https://gitlab.com/org/name"
        )
    ...
    def test_invalid_git_allowed_hosts(self) -> None:
    ...
    def test_get_unique_path(self) -> None:
        ...
        assert git_url.get_repo_dir_name("https://github.com/apache/maven") == os.path.normpath(
            "github_com/apache/maven"
        )
        assert git_url.get_repo_dir_name("https://gitlab.com/apache/maven") == os.path.normpath(
            "gitlab_com/apache/maven"
        )
        ...
        assert git_url.get_repo_dir_name("git@git.host.blah:apache/maven") == os.path.normpath(
            "git_host_blah/apache/maven"
        )
